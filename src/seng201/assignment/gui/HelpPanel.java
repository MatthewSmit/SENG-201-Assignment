...
final class HelpPanel extends JPanel {
    ...
    HelpPanel() {
        ...
        textPane.setText("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 3.2//EN\">\n"
+ "<html>\n"
+ "    <head>\n"
+ "    </head>\n"
+ "    <body>\n"
...
+ "</table>\n"
+ "<p>\n"
+ "The game takes place over a configurable number of days, between 1-3 players. "
+ "During each day, each player has a turn to control their pets. "
+ "Each player has a certain amount of money that can be used to buy food and toys. Each pet has 2 actions that can be used each day.\n"
+ "<p>\n"
...
+ "<p>\n"
+ "Each day certain events can happen. Pets can get sick, or start misbehaving. "
+ "Becoming sick requires medicine to get better, otherwise it will continue to get sick and may die. "
+ "Pets are able to be revived from death once, but only once. "
+ "Pets are more likely to get sick if it is overweight or too hungry, and pets may misbehave if they are unhappy or hungry.\n"
+ "    </body>\n"
+ "</html>");
